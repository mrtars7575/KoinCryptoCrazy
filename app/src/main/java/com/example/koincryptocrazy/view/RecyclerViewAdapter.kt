...
import com.example.koincryptocrazy.databinding.RecyclerRowBinding
import com.example.koincryptocrazy.model.CryptoList
import com.example.koincryptocrazy.model.CryptoListItem

class RecyclerViewAdapter( val cryptoList : CryptoList , val listener : Listener) : RecyclerView.Adapter<RecyclerViewAdapter.RowHolder>() {

    interface Listener {
        fun onItemClick(cryptoModel: CryptoListItem)
    }
